...
app.controller('HighchartChart', function($scope,$stateParams) {
  ...
  $scope.chartSeries = [
    {"name": '测试',
     "data": [
                [Date.UTC(2010, 1, 1), 33.9],
                [Date.UTC(2010, 1, 2), 44.5],
                ...
                [Date.UTC(2010, 1, 11), 123.4],
                [Date.UTC(2010, 1, 12), 31.2],
                [Date.UTC(2010, 1, 13), 144.0],
                [Date.UTC(2010, 1, 14), 23.0],
                [Date.UTC(2010, 2, 1), 29.9],
                [Date.UTC(2010, 2, 2), 71.5],
                [Date.UTC(2010, 2, 3), 123.4],
                [Date.UTC(2010, 2, 6), 111.2],
                [Date.UTC(2010, 2, 7), 45.0],
                [Date.UTC(2010, 2, 8), 65.0],
             ]
